...
#torchvision.datasets.VOCDetection(root="../datasets/vocdet/trainval", image_set="trainval", download=True, year="2012")

torchvision.datasets.VOCSegmentation(root="../datasets/vocseg/train", image_set="train", download=True, year="2012")
torchvision.datasets.VOCSegmentation(root="../datasets/vocseg/trainval", image_set="trainval", download=True, year="2012")
torchvision.datasets.VOCSegmentation(root="../datasets/vocseg/test", image_set="val", download=True, year="2012")
"""
